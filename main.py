...
async def main():
    ...
    urls = list()
    apis =[
        "OAvEkdOx00yI8pZNab1gRAEFrc8yVQA2", "zNxwJWw2G4QouXNvFx2fMaUujl2RYhUB"]
    ...
    for api in apis:
        for _ in range(randint (3,5)):
            url = f"https://api.webscrapingapi.com/v2?api_key=Tt9wljgaJPFEJytneHc4WUzn5LeDuB8M&url={ad}&country=us&render_js=1"
            urls.append(url)
